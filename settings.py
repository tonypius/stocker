...
# The BitMEX API requires permanent API keys. Go to https://testnet.bitmex.com/api/apiKeys to fill these out.
API_KEY = "aRbevrzbZyHHVSmYevf7n3jB"
API_SECRET = "duQeDsJ2-hFbQynhdolKyEd18wszjWpkFnTVaybeCy7conaf"
#Account tonypiusalapatt@gmail.com
